...
const exhibitorVisibilityInit = {
  fieldIdStandard: [],
  fieldIdQuestion: [],
  registrationFormId: null,
};
const exhibitorVisibility = reactive({ ...exhibitorVisibilityInit });
...
const handleSubmit = async () => {
  ...
  store
    .dispatch("badge/addExhibitorVisibility", exhibitorVisibility)
    .then((result) => {
      router.push({
        name: "event-single",
...
watch(
  () => exhibitorVisibility.registrationFormId,
  (newVal, oldVal) => {
    ...
    <v-row justify="center">
      <v-col>
        ...
        >
          ...
          ></v-select>
          <v-select
            v-model="exhibitorVisibility.registrationFormId"
            :items="forms"
                  ...
                  <tr v-for="item in fields" :key="item.id">
                    <td>
                      <div class="d-flex align-center justify-space-around">
                        ...
                        <v-checkbox
                          v-model="exhibitorVisibility.fieldIdStandard"
                          :value="item.id"
                          density="compact"
                          hide-details
                        ></v-checkbox>
                  ...
                  >
                    <td>
                      <div class="d-flex align-center justify-space-around">
                        ...
                        <v-checkbox
                          v-model="exhibitorVisibility.fieldIdQuestion"
                          :value="item.id"
                          density="compact"
                          hide-details="auto"
                        ></v-checkbox>
